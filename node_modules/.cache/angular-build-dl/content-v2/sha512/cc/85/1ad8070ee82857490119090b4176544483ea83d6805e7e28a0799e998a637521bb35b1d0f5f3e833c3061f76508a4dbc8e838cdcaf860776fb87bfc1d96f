...
/* harmony import */ var _temp_data_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../temp-data.service */ "./src/app/temp-data.service.ts");
...
/* harmony import */ var _crop_crop_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../crop/crop.page */ "./src/app/crop/crop.page.ts");
...
let EditPage = class EditPage {
    constructor(viewCtrl, camera, toastCtrl, loadingCtrl, navCtrl, service, firestore, actRoute) {
        ...
        this.onSuccess = snapshot => {
            ...
            firebase__WEBPACK_IMPORTED_MODULE_9__["storage"]().ref().child(this.coinref.front).getDownloadURL()
                .then(response => {
        ...
        this.onSuccess1 = snapshot => {
            //this.currentImage = snapshot.downloadURL;
            firebase__WEBPACK_IMPORTED_MODULE_9__["storage"]().ref().child(this.coinref.back).getDownloadURL()
                .then(response => {
    ...
    uploadFront(x) {
        if (this.selectedPhoto && this.formValidation()) {
            var uploadTask = firebase__WEBPACK_IMPORTED_MODULE_9__["storage"]().ref().child(x)
