(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["filter-filter-module"], {
    ...
    function srcAppFilterFilterRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _filter_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./filter.page */
      ...
      var routes = [{
        path: '',
        component: _filter_page__WEBPACK_IMPORTED_MODULE_2__["FilterPage"]
      }];
      ...
      FilterPageRoutingModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
    ...
    function srcAppFilterFilterModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _filter_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./filter-routing.module */
      "./src/app/filter/filter-routing.module.ts");
      /* harmony import */


      var _filter_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./filter.page */
      "./src/app/filter/filter.page.ts");
      ...
      FilterPageModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _filter_routing_module__WEBPACK_IMPORTED_MODULE_4__["FilterPageRoutingModule"]],
        declarations: [_filter_page__WEBPACK_IMPORTED_MODULE_5__["FilterPage"]]
      })], FilterPageModule);
      /***/
    }
  }]);
