  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~filter-filter-module~home-home-module"], {
    ...
    function srcAppFilterFilterPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var FilterPage = /*#__PURE__*/function () {
        function FilterPage(viewCtrl, service, navCtrl, router) {
      ...
      FilterPage = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-filter',
    ...
    function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _temp_data_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ../temp-data.service */
      "./src/app/temp-data.service.ts");
      /* harmony import */
      ...
      var _add_coin_add_coin_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../add-coin/add-coin.page */
      ...
      var _display_display_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../display/display.page */
      "./src/app/display/display.page.ts");
      /* harmony import */


      var _stats_stats_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../stats/stats.page */
      "./src/app/stats/stats.page.ts");
      /* harmony import */


      var _filter_filter_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../filter/filter.page */
      "./src/app/filter/filter.page.ts");
      /* harmony import */
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(service, modalCtrl, loadingCtrl, toastCtrl, alertController, firestore, navCtrl) {
          var _this = this;
          ...
          this.adminColor = "primary"; //frontUrl;
          //backUrl;
        ...
        _createClass(HomePage, [{
          ...
          key: "initializeItems2",
          value: function initializeItems2() {
            //this.coins=this.CoinData;
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      val = ev.target.value;
                      console.log(val); //console.log("val "+typeof(parseInt()))
                      // if the value is an empty string don't filter the items

                      if (val && val.trim() != '') {
                        this.coins = this.coins.filter(function (item) {
                      ...
                      console.log("yeees");
                      console.log(this.coins); //console.log(this.listHeight)
          ...
          key: "filterItems",
          value: function filterItems(x) {
            return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
              var loader, val, val2, compare, compare2, compare3, compare4;
                ...
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    ...
                    case 2:
                      ...
                      // Reset items back to all of the items
                      this.initializeItems();
                      console.log(this.coins); // set val to the value of the searchbar
                      ...
                      if (x.f_price == "Price LH") {
                        compare2 = function compare2(a, b) {
                          var x = Number(a.price);
                          var y = Number(b.price);
                      ...
                      if (x.f_year == "Year HL") {
                        compare3 = function compare3(a, b) {
                          if (a.year < b.year) {
                            return 1;
                          }
                      ...
                      if (x.f_year == "Year LH") {
                        compare4 = function compare4(a, b) {
                          if (a.year < b.year) {
                            return -1;
                          }
                    ...
                    case 0:
                      ...
                      try {
                        this.firestore.collection("coins").snapshotChanges().subscribe(function (data) {
                          _this3.coins = data.map(function (e) {
                            return {
                              id: e.payload.doc.id,
                          ...
                          _this3.listHeight = _this3.coins.length * 68;
                          _this3.CoinData = _this3.coins;
                          _this3.service.coinData = _this3.CoinData;
                          _this3.filterFlag = !_this3.filterFlag;
                          console.log("Filterflag" + _this3.filterFlag);
                          setTimeout(function () {
                            _this3.shimmer = false;
                          }, 2000);

                          if (_this3.filterFlag == true) {
                            _this3.filterItems(_this3.fdata);
                          }
                        }); // dismiss loader
                        // loader.dismiss();
                      } catch (e) {
          ...
          key: "store",
          value: function store(x) {
            console.log("Meta");
            console.log(x);
          }
        }, {
          key: "delete",
          value: function _delete(id, x, y) {
                                ...
                                while (1) {
                                  switch (_context7.prev = _context7.next) {
                                    ...
                                    case 3:
                                      ...
                                      firebase__WEBPACK_IMPORTED_MODULE_8__["storage"]().ref().child(x)["delete"]().then(function (response) {
                                        return console.log(response);
                                      })["catch"](function (error) {
                                        return console.log('error', error);
                                      });
                                      firebase__WEBPACK_IMPORTED_MODULE_8__["storage"]().ref().child(y)["delete"]().then(function (response) {
                                        return console.log(response);
                                      })["catch"](function (error) {
                                        return console.log('error', error);
                                      });
                                      _context7.next = 9;
                                      return this.firestore.doc("coins/" + id)["delete"]();
          ...
          value: function closeChip(x) {
            ...
            if (this.chipFlag[0] == 0 && this.chipFlag[1] == 0 && this.chipFlag[2] == 0 && this.chipFlag[3] == 0) {
              ...
              this.filterFlag = true; //this.modalCtrl.dismiss();
          ...
          value: function doRefresh(event) {
            ...
            this.filterFlag = true;
            this.coins = this.service.coinData;
            this.fcoins = this.coins; // console.log("Checking logs")
            // console.log(this.filterFlag)
            // console.log(this.coins)
            // console.log(this.fcoins)
            // console.log(this.CoinData)
            ...
            setTimeout(function () {
              for (i = 0; i < _this6.service.modalInstance.length; i++) {
                _this6.service.modalInstance[i].dismiss();
              }

              setTimeout(function () {
                _this6.shimmer = false;
              }, 3000);
            }, 2000);
            this.service.modalInstance = [];
          }
                ...
                while (1) {
                  switch (_context11.prev = _context11.next) {
                    case 0:
                      ...
                      try {
                        this.firestore.collection("coins").snapshotChanges().subscribe(function (data) {
                          _this7.coins = data.map(function (e) {
                            return {
                              id: e.payload.doc.id,
                              name: e.payload.doc.data()["name"],
                              year: e.payload.doc.data()["year"],
...
//# sourceMappingURL=default~filter-filter-module~home-home-module-es5.js.map