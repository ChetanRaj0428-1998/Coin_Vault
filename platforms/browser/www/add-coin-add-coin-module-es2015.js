...
/* harmony import */ var _add_coin_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./add-coin.page */ "./src/app/add-coin/add-coin.page.ts");
...
AddCoinPageRoutingModule = __decorate([
...
/* harmony import */ var _add_coin_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./add-coin-routing.module */ "./src/app/add-coin/add-coin-routing.module.ts");
/* harmony import */ var _add_coin_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./add-coin.page */ "./src/app/add-coin/add-coin.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AddCoinPageModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        imports: [
            ...
            _add_coin_routing_module__WEBPACK_IMPORTED_MODULE_4__["AddCoinPageRoutingModule"]
        ],
